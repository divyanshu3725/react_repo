...
const TopRestaurant0 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[0].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[0])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[0].info.name}</span></div>
                <div>
                    ...
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[0])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[0].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[0].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[0].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant1 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[1].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[1])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[1].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[1])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[1].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[1].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[1].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant2 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[2].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[2])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[2].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[2])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[2].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[2].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[2].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant3 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[3].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[3])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[3].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[3])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[3].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[3].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[3].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant4 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[4].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[4])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[4].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[4])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[4].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[4].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[4].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant5 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[5].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[5])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[5].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[5])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[5].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[5].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[5].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant6 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[6].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[6])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[6].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[6])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[6].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[6].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[6].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant7 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[7].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[7])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[7].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[7])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[7].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[7].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[7].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant8 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[8].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[8])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[8].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[8])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[8].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[8].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[8].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant9 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[9].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[9])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[9].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[9])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[9].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[9].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[9].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant10 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[10].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[10])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[10].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[10])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[10].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[10].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[10].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant11 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[11].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[11])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[11].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[11])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[11].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[11].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[11].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant12 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[12].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[12])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[12].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[12])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[12].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[12].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[12].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant13 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[13].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[13])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[13].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[13])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[13].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[13].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[13].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant14 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[14].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[14])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[14].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[14])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[14].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[14].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[14].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant15 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[15].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[15])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[15].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[15])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[15].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[15].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[15].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant16 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[16].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[16])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[16].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[16])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[16].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[16].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[16].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant17 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[17].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[17])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[17].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[17])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[17].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[17].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[17].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant18 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[18].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[18])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[18].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[18])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[18].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[18].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[18].info.areaName}</div>
            </div>
        </div>
    )
};
const TopRestaurant19 = () => {
    return (
        <div className="pizzaHut inline-block box-border inline-block relative border-2 border-solid border-white mr-[20px] w-[273px]">
            <img className="relative" style={{ width: '273px', height: '182px', cursor: 'pointer', objectFit: 'cover', borderRadius: '20px' }} src={`${topRestaurantImageURLInitialPart}${restaurantsArray1[19].info.cloudinaryImageId}`} alt="Pizza Hut"></img>
            <div className="w-[273px] rounded-[20px] color h-[73px] flex items-end absolute bottom-[127px]" style={{ backgroundImage: 'linear-gradient(rgba(27, 30, 36, 0) 0%, rgb(27, 30, 36) 84.21%)' }}>
                <div className="text-[22px] font-[800] tracking-[-0.5px] text-white px-[12px] py-[6px]">{showCuisines(restaurantsArray1[19])}</div>
            </div>
            <div className="p-[14px]">
                <div className="font-bold text-[18px]"><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[19].info.name}</span></div>
                <div>
                    <svg className="inline-block mr-[5px]" width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true" strokeColor="rgba(2, 6, 12, 0.92)" fillColor="rgba(2, 6, 12, 0.92)"><circle cx="10" cy="10" r="9" fill="url(#StoreRating20_svg__paint0_linear_32982_71567)"></circle><path d={topRestaurantsSVGdValue} fill="white"></path><defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                    <span className="mr-[8px] font-bold">{showRating(restaurantsArray1[19])}</span>
                    <span className="mr-[5px] font-bold">{restaurantsArray1[19].info.sla.slaString}</span>
                </div>
                <div><span className="overflow-hidden text-ellipsis block">{restaurantsArray1[19].info.cuisines.join(', ')}</span></div>
                <div>{restaurantsArray1[19].info.areaName}</div>
            </div>
        </div>
    )
};
